...
class UserCommandActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new UserCommandFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = UserCommandFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UserCommandActionFeedback(null);
    ...
    data.feedback = UserCommandFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += UserCommandFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UserCommandActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = UserCommandFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new UserCommandFeedback()
    }
...
module.exports = UserCommandActionFeedback;
