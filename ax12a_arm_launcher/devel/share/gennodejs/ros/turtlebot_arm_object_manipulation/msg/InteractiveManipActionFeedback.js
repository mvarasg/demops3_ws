...
class InteractiveManipActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new InteractiveManipFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = InteractiveManipFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new InteractiveManipActionFeedback(null);
    ...
    data.feedback = InteractiveManipFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InteractiveManipActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = InteractiveManipFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new InteractiveManipFeedback()
    }
...
module.exports = InteractiveManipActionFeedback;
