...
"""autogenerated by genpy from turtlebot_arm_object_manipulation/PickAndPlaceGoal.msg. Do not edit."""
import sys
...
class PickAndPlaceGoal(genpy.Message):
  _md5sum = "1bcb111268b41ca6dd486e805ddf52aa"
  _type = "turtlebot_arm_object_manipulation/PickAndPlaceGoal"
...
float64 w
"""
  __slots__ = ['frame','obj_name','header','pick_pose','place_pose']
  _slot_types = ['string','string','std_msgs/Header','geometry_msgs/Pose','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       frame,obj_name,header,pick_pose,place_pose
