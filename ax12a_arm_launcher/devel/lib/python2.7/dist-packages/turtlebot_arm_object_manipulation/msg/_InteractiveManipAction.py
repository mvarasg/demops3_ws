...
"""autogenerated by genpy from turtlebot_arm_object_manipulation/InteractiveManipAction.msg. Do not edit."""
import sys
...
class InteractiveManipAction(genpy.Message):
  _md5sum = "d8e7d00e0440fb8c7d8d203354764d3c"
  _type = "turtlebot_arm_object_manipulation/InteractiveManipAction"
...
"""
  ...
  _slot_types = ['turtlebot_arm_object_manipulation/InteractiveManipActionGoal','turtlebot_arm_object_manipulation/InteractiveManipActionResult','turtlebot_arm_object_manipulation/InteractiveManipActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InteractiveManipAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = turtlebot_arm_object_manipulation.msg.InteractiveManipActionGoal()
      if self.action_result is None:
        self.action_result = turtlebot_arm_object_manipulation.msg.InteractiveManipActionResult()
      if self.action_feedback is None:
        self.action_feedback = turtlebot_arm_object_manipulation.msg.InteractiveManipActionFeedback()
    else:
      self.action_goal = turtlebot_arm_object_manipulation.msg.InteractiveManipActionGoal()
      self.action_result = turtlebot_arm_object_manipulation.msg.InteractiveManipActionResult()
      self.action_feedback = turtlebot_arm_object_manipulation.msg.InteractiveManipActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.obj_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.obj_name = str[start:end].decode('utf-8')
      else:
        self.action_result.result.obj_name = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.pick_pose.position.x, _x.action_result.result.pick_pose.position.y, _x.action_result.result.pick_pose.position.z, _x.action_result.result.pick_pose.orientation.x, _x.action_result.result.pick_pose.orientation.y, _x.action_result.result.pick_pose.orientation.z, _x.action_result.result.pick_pose.orientation.w, _x.action_result.result.place_pose.position.x, _x.action_result.result.place_pose.position.y, _x.action_result.result.place_pose.position.z, _x.action_result.result.place_pose.orientation.x, _x.action_result.result.place_pose.orientation.y, _x.action_result.result.place_pose.orientation.z, _x.action_result.result.place_pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_14d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
