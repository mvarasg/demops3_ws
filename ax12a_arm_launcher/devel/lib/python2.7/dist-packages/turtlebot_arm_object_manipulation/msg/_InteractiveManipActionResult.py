...
"""autogenerated by genpy from turtlebot_arm_object_manipulation/InteractiveManipActionResult.msg. Do not edit."""
import sys
...
class InteractiveManipActionResult(genpy.Message):
  _md5sum = "46b5fda6346676c752210a7d1fde6f74"
  _type = "turtlebot_arm_object_manipulation/InteractiveManipActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtlebot_arm_object_manipulation/InteractiveManipResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InteractiveManipActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = turtlebot_arm_object_manipulation.msg.InteractiveManipResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = turtlebot_arm_object_manipulation.msg.InteractiveManipResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_14d().pack(_x.result.pick_pose.position.x, _x.result.pick_pose.position.y, _x.result.pick_pose.position.z, _x.result.pick_pose.orientation.x, _x.result.pick_pose.orientation.y, _x.result.pick_pose.orientation.z, _x.result.pick_pose.orientation.w, _x.result.place_pose.position.x, _x.result.place_pose.position.y, _x.result.place_pose.position.z, _x.result.place_pose.orientation.x, _x.result.place_pose.orientation.y, _x.result.place_pose.orientation.z, _x.result.place_pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.obj_name = str[start:end].decode('utf-8')
      else:
        self.result.obj_name = str[start:end]
      _x = self
      start = end
      end += 12
